...
| [Phase 0 runtime spike 报告](wasm-policy/WASM策略Phase0-runtime-spike.md) | 基准针对 Rust 1.91 / Wasmtime 43；当前仓库使用 Rust 1.98 / Wasmtime 48。 | Pulley 与 Cranelift 取舍的原始测量和方法。 |
