...
pub struct PeerCounters {
    ...
    pub fec_block_timeout_millis: AtomicU64,
...
impl PeerCounters {
    pub fn new(name: String, endpoint_id: EndpointId, interface: String) -> Self {
        Self {
            ...
            fec_block_timeout_millis: AtomicU64::new(0),
...
pub struct PeerStatus {
    ...
    #[serde(default)]
    pub fec_recovery_shards: u64,
    #[serde(default)]
    pub fec_block_timeout_millis: u64,
...
fn peer_snapshot(peer: &PeerCounters) -> PeerStatus {
    PeerStatus {
        ...
        fec_block_timeout_millis: peer.fec_block_timeout_millis.load(Ordering::Relaxed),
